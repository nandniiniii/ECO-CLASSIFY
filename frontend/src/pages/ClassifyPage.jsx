...
const CATEGORIES = [
  { name: "Plastic", emoji: "🧴", color: "border-blue-500/40 bg-blue-500/10", desc: "Bottles, bags, containers, straws" },
  { name: "Paper", emoji: "📄", color: "border-amber-500/40 bg-amber-500/10", desc: "Newspaper, cardboard, envelopes" },
  { name: "Glass", emoji: "🫙", color: "border-cyan-500/40 bg-cyan-500/10", desc: "Bottles, jars, windowpanes" },
  { name: "Metal", emoji: "🥫", color: "border-zinc-400/40 bg-zinc-400/10", desc: "Cans, foil, scrap metal" },
  { name: "Organic", emoji: "🍌", color: "border-green-500/40 bg-green-500/10", desc: "Food scraps, peels, garden waste" },
  { name: "E-Waste", emoji: "💻", color: "border-red-500/40 bg-red-500/10", desc: "Phones, batteries, chargers" },
];
    ...
    <div className="text-white">
      <div className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="absolute inset-0 pointer-events-none"
          style={{ backgroundImage: "radial-gradient(circle at 20% 50%, rgba(57,229,140,0.07) 0%, transparent 60%), radial-gradient(circle at 80% 20%, rgba(45,212,191,0.05) 0%, transparent 50%)" }} />
        <div className="max-w-5xl mx-auto px-6 py-20 relative">
          ...
          <p className="text-white/60 text-lg max-w-xl mb-8">
            Upload a photo or describe any item — our AI instantly tells you how to dispose of it correctly, and tracks your environmental impact.
          </p>
